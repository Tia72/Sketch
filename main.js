...
document.getElementById("sn").innerHTML = "Sketch to be drawn : " + element_of_array;
...
function updateCanvas(){
    ...
    sketch = Element_of_array;
    document.getElementById("sn").innerHTML = "Sketch to be drawn : " + sketch;
}
...
function gotResult(error,results){
    ...
    document.getElementById("tys").innerHTML = "Your Sketch : " + drawn_sketch;
